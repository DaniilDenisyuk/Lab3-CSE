...
{
    public class BinaryFlagWhiteBoxTest
    {
    ...
    [Theory]
    [InlineData(32, true, "UIntConcreteBinaryFlag")]
    [InlineData(33, true, "ULongConcreteBinaryFlag")]
    [InlineData(64, false, "ULongConcreteBinaryFlag")]
    [InlineData(65, true,  "UIntArrayConcreteBinaryFlag")]
